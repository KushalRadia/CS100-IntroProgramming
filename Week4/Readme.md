# Week 4: Practice Session for the Basics of Python Module

# Study Materials 

As per the TA's covering any topics in the Lab session we are sharing the reference file and links. 

* [Python Native Tutorials](https://pynative.com/)
* [Loops Presentation](./reference_doc/Pythonlearn-05-Iterations.pptx)
* [Function Presentation](./reference_doc/Pythonlearn-05-Iterations.pptx)
...
* [Python documentation](https://docs.python.org/3.10/index.html)


# YouTube Videos

* [Flowgorithm coins solution](https://www.youtube.com/watch?v=6KMydOq2YM0)
* [Permutation in the list for ABC — problem statement](https://www.youtube.com/watch?v=YmjOQNR2_1M)
* [Function Tutorials](https://www.youtube.com/watch?v=BR1WtbgwZH4)
* [Basic Number Slider Game — Part 1 Tutorial](https://youtu.be/w46OGe5kf2Q)
* [Basic Number Slider Game — Part 2 Tutorial](https://youtu.be/gEHUb8k4xGI)
